...
namespace sintret\diesel\generators\model;
...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return 'DIESEL MODEL is a generator generates an ActiveRecord class for the specified database table.';
    }
